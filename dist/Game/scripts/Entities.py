...
class Player(PhysicsEntity):
    ...
    def __init__(self, game, pos, size):
        ...
        self.jumps = 1           # Number of jumps remaining, used for multi-jumping/wall jumps
    ...
    def Update(self, tilemap, movement=(0, 0)):
        ...
        if self.collisions['down']:  # If standing on top of a tile:
            ...
            self.jumps = 1           # Restore a jump, allowing the player to jump again
    ...
    def Jump(self):
        ...
        if self.wall_slide:
            ...
            if self.flip and self.last_movement[0] < 0:
                self.velocity[0] = 3.5    # Push away from wall horizontally.
                self.velocity[1] = -2.5   # Jump upward.
